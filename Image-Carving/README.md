...
Second, for each pixel, calculate cumulative minimum energy *Mx*
...
Finally, the end of the minimal connected vertical seam resides right at the minimum value of the last row in *_Mx_*. And then, backtrack all the way up from this minimum entry on *Mx* to the first row in *Mx* to find the path of the optimal seam.
